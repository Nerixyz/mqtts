...
export class OutgoingPublishFlow extends PacketFlow<MqttMessageOutgoing> {
    private readonly identifier: number;
    private readonly message: MqttMessageOutgoing;
    private receivedPubRec = false;

    public constructor(message: MqttMessageOutgoing, identifier?: number) {
        super();
